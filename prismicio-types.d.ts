...
export interface SettingsDocumentDataFooterSkateboardsItem {
  /**
   * Skateboards field in *Settings → Footer Skateboards*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.footer_skateboards[].skateboards
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  skateboards: prismic.ImageField<never>;
}
...
interface SkatersDocumentData {
  ...
  /**
   * Photo Background field in *Skaters*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skaters.photo_background
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  ...
  /**
   * Photo Foreground field in *Skaters*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skaters.photo_foreground
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  ...
  /**
   * Customizer Link field in *Skaters*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skaters.customizer_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customizer_link: prismic.LinkField<
...
export interface TextandImageSliceDefaultPrimary {
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: textand_image.default.primary.foreground_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface TextandImageSliceImageOnLeftPrimary {
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: textand_image.imageOnLeft.primary.foreground_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  foreground_image: prismic.ImageField<never>;
}
